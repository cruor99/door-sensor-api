...
class DoorResource(Resource):
    ...
    def get(self, door_id):
        ...
        return jsonify({"event": schema.dump(event).data})
    ...
    def put(self, door_id):
        ...
        return jsonify({"msg": "door event updated", "event": schema.dump(event).data})
    ...
    def delete(self, door_id):
        ...
        return jsonify({"msg": "door event deleted"})
...
class DoorList(Resource):
    ...
    def post(self):
        ...
        return jsonify({"msg": "door event created", "event": schema.dump(event).data}), 201
